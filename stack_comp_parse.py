...
COMP_CSV = "compstat_142133.csv"


STACK_LOG = "qemu_instance-000005be_25022021.log"
VCPUS = 4
F_LIST = ["flush_workqueue+"]
...
def log_crunch():
    ...
    with open(COMP_LOG, 'r') as f:
        ...
        while True:
            ...
            if len(compstat) == 3:
                ...
                #compstat = append_events(compstat, f_time_dict)
    ...
    for i in range(len(compstat_list)-1):
        ...
        cur_time = int(cur_compstat[0][8:])
        cur_date = cur_compstat[0][:8]
        next_time = int(next_compstat[0][8:])
        next_date = next_compstat[0][:8]         
        ...
        if pre_time_func_dict:
             ...
             for t in t_list:
                ...
                stat_list.append([cur_date + str(t)] +
                                 payload +
        ...
        if post_time_func_dict:
             ...
             for t in t_list:
                ...
                stat_list.append([next_date + str(t)] +
                                 payload +
                                 [str(b) for b in bit_list])
