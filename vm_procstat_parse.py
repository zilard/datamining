...
VM_FILE = "vm-collect-iocpu.log_20210216_084441"
PROCSTAT_CSV = "vm_procstat_084441.csv"



def ll_sp_value(value1, value2, itv):
    if ((value1 < value1) and (int(value1) <= 0xffffffff)):
                ...
                if procstat_rec_started:
                    ...
                    if procstat_lineno > 2:
                        ...
                        if cpu in procstat_dict:
                            ...
                            steal = "%.2f" % ll_sp_value(p_steal, c_steal, interval)

                            guest = "%.2f" % ll_sp_value(p_guest, c_guest, interval)

                            guest_nice = "%.2f" % ll_sp_value(p_guest_nice, c_guest_nice, interval)

                            procstat = procstat + [user, nice, system, iowait, hardirq, softirq, steal, guest, guest_nice]
